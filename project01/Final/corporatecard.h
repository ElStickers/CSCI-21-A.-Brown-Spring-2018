 ...
 */
 ...
 #ifndef CORPORATECARD_H
 #define CORPORATECARD_H
  ...
  */
class CorporateCard : public Card {
protected:
...
public:
    ...
    CorporateCard(); //Constructor, sets variables to default values unless argument is present
