...
double CorporateCard::credit_amount() {
...
double CorporateCard::overdraft_allowance() {
...
void CorporateCard::CheckDenied() {
...
void CorporateCard::set_credit_amount(double credit_amount) {
...
void CorporateCard::set_overdraft_allowance(double overdraft_allowance) {
...
void CorporateCard::set_rebate(int rebate) {
