/*
 * Name        : temperature.h
 * Author      : Luke Sathrum / Juan Palos
...
class Temperature {
 public:
   ...
   * HINT: You may just want to call the set_kelvin() mutator function
   ...
   * HINT: You may just want to call set_kelvin, SetTempFromCelsius and
   ...
   * HINT: You may want to call the kelvin(), GetTempAsCelsius() and 
   *       GetTempAsFahrenheit functions
